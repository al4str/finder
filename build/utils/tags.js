 ...
 * @return {BuildTagItem}
 * */
function tagsGetItemModule(url) {
 ...
 * @return {BuildTagItem}
 * */
function tagsGetItemNoModule(url) {
  return tagsCreateItem('script', {
    src: url,
    defer: true,
    nomodule: true,
 ...
 * */
function tagsGetResourceDirective(url) {
